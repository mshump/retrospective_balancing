...
test_mbr <- floor(runif(strat_n, min = 0 , max = 1000))
...
# test total
###########
x <- c(sum(strata_summary$test_resp) , sum(strata_summary$control_resp))
n <- c(sum(strata_summary$test_mbr) , sum(strata_summary$control_mbr))
